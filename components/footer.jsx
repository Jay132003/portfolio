    ...
    <footer className="w-full">
        ...
        <div className="bg-white dark:bg-[#212121]">
          ...
          <div className="mb-8 text-center">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-[#FFFFFF] mb-4">The Future Needs Your Vision.</h2>
            <p className="text-lg text-gray-600 dark:text-[#C0C0C0] mb-8">And I’ll make sure it looks and feels extraordinary.</p>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-4">
                ...
                <a
                  ...
                  className="flex h-12 w-12 items-center justify-center rounded-full border-2 dark:bg-[#212121] 
                  dark:border-[#212121] 
                  dark:text-white 
                  border-gray-300 
